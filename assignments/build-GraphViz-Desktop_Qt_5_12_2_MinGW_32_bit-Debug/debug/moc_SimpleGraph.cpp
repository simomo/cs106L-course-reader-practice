...
void SimpleGraph::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (SimpleGraph::*)(SimpleGraph );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SimpleGraph::graphUpdated)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject SimpleGraph::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_SimpleGraph.data,
    qt_meta_data_SimpleGraph,
    qt_static_metacall,
    nullptr,
    nullptr
} };
